...
[ -n "$opt_subdomain" ] && ( query "insert into https_subdomains_alias(link,is_https,target,domain) values ('$opt_redirect_val','$opt_encrypted_val','$opt_subdomain_val','$opt_domain_val');" || error "Client integrity at risk; aborting" )
